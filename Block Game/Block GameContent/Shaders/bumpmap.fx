...
VertexShaderOutput VertexShaderFunction(VertexShaderInput input)
{
    ...
    output.Normal = input.Normal;//normalize(mul(input.Normal, WorldInverseTranspose));
    output.Tangent = input.Tangent;//normalize(mul(input.Tangent, WorldInverseTranspose));
    output.Binormal = input.Binormal;//normalize(mul(input.Binormal, WorldInverseTranspose));
