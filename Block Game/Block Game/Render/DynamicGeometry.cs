...
namespace BlockGame.Render
{
    ...
    public class DynamicGeometry<T> where T : struct, IVertexType
    {
        /// <summary>
        /// The vertex buffer to render with
        /// </summary>
        protected DynamicVertexBuffer _vertBuffer;
        /// <summary>
        /// The index buffer to render with
        /// </summary>
        protected DynamicIndexBuffer _indexBuffer;
        ...
        public DynamicGeometry(GraphicsDevice graphics, PrimitiveType primitiveType, int vSize, int iSize)
        {
            _graphics = graphics;
            ...
            _vertBuffer = new DynamicVertexBuffer(graphics, typeof(T), vSize, BufferUsage.WriteOnly);
            _indexBuffer = new DynamicIndexBuffer(graphics, IndexElementSize.ThirtyTwoBits, iSize, BufferUsage.WriteOnly);
        ...
        /// </summary>
        public void Render(EffectTechnique technique)
        {
